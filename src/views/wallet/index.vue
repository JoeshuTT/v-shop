    ...
    <div class="header">
      ...
      <div class="amount">
        <div class="amount-item">
          ...
          <div class="amount-item-value">{{ detail.balance | countPair }}</div>
        </div>
        <div class="amount-item">
          <div class="amount-item-label">冻结余额</div>
          <div class="amount-item-value">{{ detail.freeze | countPair }}</div>
        </div>
        <div class="amount-item">
          <div class="amount-item-label">累计消费</div>
          <div class="amount-item-value">{{ detail.totleConsumed | countPair }}</div>
        </div>
      </div>
    </div>
